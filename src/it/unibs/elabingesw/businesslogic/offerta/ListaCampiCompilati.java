...
public class ListaCampiCompilati implements Serializable {
     ...
     * <p>
     * Post condizione: inizializza attributo di classe.
     */
     ...
     * valore di compilazione associato.
     * <p>
     * Precondizione: assumo parametri costruttore non nulli e
     * correttamente inizializzati.
     * Per campo intendo che sia una istanza di un campo nativo (non già aggiunta in elenco)
     * di una categoria padre della categoria foglia o di essa stessa,
     * a cui l'offerta, per quale si sta associando questa istanza di
     * ListaCampiCompilati, sia appartenente.
     * Per valore intendo che sia diversa da una stringa vuota.
     *
     * @param campo  oggetto di tipo Campo
     * @param valore il valore del campo che si vuole associare.
     */
