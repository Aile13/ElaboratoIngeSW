...
/**
 * Classe SelezionataState per gestire un'offerta selezionata.
 *
 * @author Elia Pitozzi
 * @author Ali Laaraj
 */
public class SelezionataState implements OffertaState {
    ...
    *
    * @param altraOffertaContextDaBarattareA oggetto di tipo OffertaContext
    ...
    */
     ...
     *
     * @param context oggetto di tipo OffertaContext
     * @return TRUE l'offerta è selezionata
     */
    @Override
