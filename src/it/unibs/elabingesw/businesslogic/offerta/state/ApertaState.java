 ...
 * @author Ali Laaraj
 */
public class ApertaState implements OffertaState {
     ...
     *
     * @param context oggetto di tipo OffertaContext
     * @return TRUE l'offerta è aperta
     */
    @Override
    ...
    public void ritiraOfferta(OffertaContext context) {
        context.setOffertaState(new RitirataState());
    }
    ...
    public void creaLegameEModificaStatiConOffertaEInfoScambio(OffertaContext context, OffertaContext offertaContextDaBarattareB, Scambio infoDiScambio) {
        context.setOffertaState(new AccoppiataState(offertaContextDaBarattareB, infoDiScambio));
        offertaContextDaBarattareB.setOffertaState(new SelezionataState(context, infoDiScambio));
    }
