...
public class MainMenu {
    ...
    public void eseguiMenuByUserType(UserType userType) {
        ...
        if (userType == UserType.CONFIGURATORE) {
            functionalMenu = new MyFunctionalMenu(
                    "Menu per Configuratore",
                    new VoceEComando[]{new VoceEComando("Esci", service::eseguiProceduraDiUscita),
                            ...
                            new VoceEComando("Visualizza offerte aperte di categoria foglia", service::visualizzaOfferteAperteConSelezioneFoglia),
                            new VoceEComando("Visualizza offerte in scambio e chiuse", service::visualizzaOfferteInScambioEChiuseConSelezioneFoglia),
            ...
            functionalMenu = new MyFunctionalMenu(
                    ...
                    new VoceEComando[]{new VoceEComando("Esci", service::eseguiProceduraDiUscita),
                            ...
                            new VoceEComando("Visualizza offerte aperte di categoria foglia", service::visualizzaOfferteAperteConSelezioneFoglia),
                            new VoceEComando("Seleziona un'altra offerta aperta per barattare", service::selezionaUnaOffertaApertaPerBaratto),
                            new VoceEComando("Visualizza proposte di scambio da altri utenti", service::visualizzaProposteDiScambio),
                            new VoceEComando("Visualizza offerte in scambio", service::visualizzaOfferteInScambio),
                            new VoceEComando("Visualizza ultime risposte per offerte in scambio", service::visualizzaUltimeRispostePerOfferteInScambio)});
        }
